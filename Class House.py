class House(object):
    ...
    def __init__(self):
	self.cellar = Room("The Cellar", "Rotten")
	self.hallway = Room("The Hallway", "Shoes")
	self.casino = Room("The Casino", "Martinis")
	self.library = Room("The Library", "Old books")
	self.living_room = Room("The Living Room", "Flowers")
	self.toilet = Room("The Toilet", "Air Freshener")
	self.kitchen = Room("The Kitchen", "Tasty soup")
	self.secret_room = Room("The Secret Room", "A serious smell")
	self.master_bedroom = Room("The Master Bedroom", "Too much perfume")
	self.guest_bedroom = Room("The Guest Bedroom", "Lemons")
        self.corridor_west = Room("The West Corridor", "Rat poison")
        self.corridor_east = Room("The East Corridor", "Cheese")
